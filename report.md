...
|------------|-------------------------------------------|----------------|---------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|------------|-------------------|----------------|
| ID         | Title                                     | ID             | Title                           | Description                                                                                                                             | Estimation | Assigned to       | Status        |
| TS-001 | Crear una Organización                                                  | TSK-001.1 | Crear Modelo de Datos OrganizationResource                               | Diseñar y definir la entidad OrganizationResource con los campos: id, Name, Type, OrgImage. Asegurar la validación de tipos y rangos básicos en el modelo.                                                      | 2h         | Marcelo Barrientos     | Done        |
|        |                                                                         | TSK-001.2 | Crear Endpoint POST /api/v1/organizations                                | Implementar el endpoint RESTful que permita recibir una solicitud POST con datos de la organización y los almacene correctamente.                                                                               | 4h         | Marcelo Barrientos        | In Progress |
|        |                                                                         | TSK-001.3 | Implementar Flujo de Creación Exitosa                                    | Asegurarse de que al recibir la solicitud con atributos válidos, la API valida y persiste la organización, y retorna una respuesta 201 Created con el OrganizationResource creado.                              | 3h         | Marcelo Barrientos | In Progress |
|        |                                                                         | TSK-001.4 | Validar Campos Obligatorios e Inválidos                                  | Agregar validaciones para que los atributos como Name y Type sean obligatorios y válidos. En caso de error, retornar una respuesta 400 Bad Request con una carga útil que describa los problemas de validación. | 2h         | Joaquin Cuba       | Done        |
| TS-002 | Obtener una Organización por id                                         | TSK-002.1 | Crear Endpoint GET /api/v1/organizations/{organizationId}                | Implementar el endpoint que permita buscar y recuperar una organización por su identificador único.                                                                                                             | 1h         | Jarod Cespedes     | Done        |
|        |                                                                         | TSK-002.2 | Implementar Escenario Encontrado                                         | Asegurar que, si se encuentra la organización, se devuelva el recurso (OrganizationResource) con una respuesta 200 OK.                                                                                          | 3h         | Marcelo Barrientos     | In Progress |
|        |                                                                         | TSK-002.3 | Implementar Escenario No Encontrado                                      | Asegurar que, si el organizationId no existe, se devuelva una respuesta 404 Not Found y devuelve una carga útil de error.                                                                                       | 1h         | Marcelo Barrientos        | In Progress |
| TS-003 | Obtener todos los Administradores por Organización                      | TSK-003.1 | Crear Endpoint GET /api/v1/organization/{organizationId}/admin           | Implementar el endpoint que lista todos los administradores asociados a una organización.                                                                                                                       | 2h         | Marcelo Barrientos | Done        |
|        |                                                                         | TSK-003.2 | Asegurar respuesta de endpoint administradores                           | Asegurar que el endpoint responde 200 OK con un array de ítems de AdminResource.                                                                                                                                | 1h         | Joaquin Cuba       | Done        |
| TS-004 | Agregar un administrador a una Organización                             | TSK-004.1 | Actualizar Modelo de Datos AdminResource                                 | Asegurar que la entidad AdminResource (id, OrgId, UserId, FirstName, LastName) y sus relaciones estén correctamente definidas.                                                                                  | 3h         | Jarod Cespedes     | Done        |
|        |                                                                         | TSK-004.2 | Crear Endpoint POST /api/v1/organization/{organizationId}/admin          | Implementar el endpoint para crear un administrador dentro del contexto de una organización.                                                                                                                    | 4h         | Marcelo Barrientos     | In Progress |
|        |                                                                         | TSK-004.3 | Implementar Flujo de Creación Exitosa                                    | Validar, persistir la relación y el recurso AdminResource, y retornar una respuesta 201 Created.                                                                                                                | 3h         | Joaquin Cuba        | In Progress |
|        |                                                                         | TSK-004.4 | Validar Atributos y Errores                                              | Agregar validaciones para OrgId, UserId, FirstName, LastName. Retornar 400 Bad Request en caso de error de validación.                                                                                          | 2h         | Marcelo Barrientos | Done        |
...
| TS-008 | Crear un Médico (Doctor)                                                | TSK-008.1 | Crear Modelo de Datos DoctorResource                                     | Diseñar y definir la entidad DoctorResource con campos clave: DoctorId, OrgId, UserId, FirstName, LastName, BirthDate, PhoneNumber, Specialty, ProfileImage.                                                    | 4h         | Marcelo Barrientos | In Progress |
|        |                                                                         | TSK-008.2 | Crear Endpoint POST /api/v1/doctors                                      | Implementar el endpoint para crear un médico.                                                                                                                                                                   | 3h         | Joaquin Cuba       | In Progress |
|        |                                                                         | TSK-008.3 | Implementar Flujo de Creación Exitosa                                    | Validar, persistir el médico y retornar 201 Created con el DoctorResource creado.                                                                                                                               | 2h         | Jarod Cespedes     | Done        |
|        |                                                                         | TSK-008.4 | Validar Atributos y Errores                                              | Añadir validaciones (ej. OrgId, UserId, Specialty obligatorios). Retornar 400 Bad Request en caso de error.                                                                                                     | 1h         | Joaquin Cuba     | Done        |
...
|        |                                                                         | TSK-016.2 | Devolver Lista de Ciudadanos Mayores                                     | Asegurar que el endpoint responde 200 OK con un array de ítems de SeniorCitizenResource.                                                                                                                        | 2h         | Jarod Cespedes        | In Progress |
| TS-017 | Agregar un ciudadano mayor a un Allegado (Relative)                     | TSK-017.1 | Actualizar Modelo de Datos SeniorCitizenResource con RelativeId          | Asegurar que la entidad SeniorCitizenResource soporte la relación con RelativeId.                                                                                                                               | 3h         | Marcelo Barrientos | In Progress |
|        |                                                                         | TSK-017.2 | Crear Endpoint POST /api/v1/relative/{relativeId}/senior-citizens        | Implementar el endpoint para crear un ciudadano mayor asociado a un allegado.                                                                                                                                   | 4h         | Joaquin Cuba       | Done        |
|        |                                                                         | TSK-017.3 | Implementar Flujo de Creación Exitosa                                    | Validar, persistir el ciudadano mayor y su relación, y retornar 201 Created con el SeniorCitizenResource creado.                                                                                                | 1h         | Jarod Cespedes     | Done        |
|        |                                                                         | TSK-017.4 | Validar Atributos y Errores                                              | Añadir validaciones. Retornar 400 Bad Request en caso de error de validación.                                                                                                                                   | 2h         | Joaquin Cuba     | In Progress |
| TS-018 | Obtener todos los Allegados                                             | TSK-018.1 | Crear Modelo de Datos RelativeResource                                   | Diseñar y definir la entidad RelativeResource con campos clave: RelativeId, Plan, SeniorCitizenId, FirstName, LastName, PhoneNumber, ProfileImage.                                                              | 3h         | Jarod Cespedes        | In Progress |
|        |                                                                         | TSK-018.2 | Crear Endpoint GET /api/v1/relatives                                     | Implementar el endpoint de listado de todos los allegados y la lógica para soportar el filtrado por categoría.                                                                                                  | 4h         | Marcelo Barrientos | Done        |
|        |                                                                         | TSK-018.3 | Devolver Lista de Allegados                                              | Asegurar que el endpoint responde 200 OK con un array de ítems de RelativeResource.                                                                                                                             | 1h         | Joaquin Cuba       | Done        |
| TS-019 | Crear un Allegado                                                       | TSK-019.1 | Crear Endpoint POST /api/v1/relatives                                    | Implementar el endpoint para crear un allegado.                                                                                                                                                                 | 2h         | Jarod Cespedes     | In Progress |
|        |                                                                         | TSK-019.2 | Implementar Flujo de Creación Exitosa                                    | Validar, persistir el allegado y retornar 201 Created con el RelativeResource creado.                                                                                                                           | 3h         | Joaquin Cuba     | Done        |
|        |                                                                         | TSK-019.3 | Validar Atributos y Errores                                              | Añadir validaciones (ej. Plan, PhoneNumber obligatorios). Retornar 400 Bad Request en caso de error.                                                                                                            | 4h         | Jarod Cespedes        | In Progress |
